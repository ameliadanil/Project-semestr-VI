...
3. Tekst wypisz wg wzoru: `The larger number is 7`.
...
3. Tekst wypisz wg wzoru: `The greatest number is 11` .
...
1. W pliku `Main07.java` stwórz dwie pętle i wypisz wartości ich liczników
...
*Zasada tworzenia pętli zagnieżdżonych została omówiona w artykule: Pętle for oraz while*
...
Rozwiązanie zadania możesz podzielić na dwie oddzielne pętle wyświetlającą:
```
* 2 3 4 5
* * 3 4 5
* * * 4 5
